...
def create_column_query(board_id, title, column_type, description):
    query = '''
    mutation {
        create_column (board_id: %s, title: "%s", column_type: %s, description: %s) {
            id
            title
            description
        }
    }
    ''' % (board_id, title, column_type, description)
    return query
